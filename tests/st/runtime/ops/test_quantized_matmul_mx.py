...
"""Supported A5 path: AIV ``quant_mx`` writes GM, AIC ``matmul_mx`` reads GM.

This is the supported staging path — not same-InCore mix. Automatic paired
data+scale pipes inside one mixed task remain a follow-up.
"""
