...
- [SkewCrossCorePipeline Pass](../../dev/passes/25-skew_cross_core_pipeline.md) —— 把跨核循环软流水到该架构上的 pass。
- [InjectGMPipeBuffer Pass](../../dev/passes/21-inject_gm_pipe_buffer.md) —— Ascend910B 上经 GM 路由的跨核 pipe workspace。
