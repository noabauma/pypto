...
> [`LowerPipelineToSlots`](30-lower_pipeline_to_slots.md) 紧接在本 pass 之前运行，在
...
- [`CanonicalizeIOOrder`](32-canonicalize_io_order.md) —— 下一个 Pass，对 `ForKind::Pipeline` 作用域内的 `SeqStmts` 做 IO 顺序规范化
