...
[`LegalizeGraphBoundary`](48-legalize_graph_boundary.md)（它本身跟在最终的
`Simplify` 之后）运行，位于
[`ClassifyIterArgCarry`](50-classify_iter_arg_carry.md) 与
[`InsertCommFence`](51-insert_comm_fence.md) 之前。跑在所有改写型 transform
