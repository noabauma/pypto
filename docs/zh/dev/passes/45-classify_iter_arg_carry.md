...
[`MaterializeRuntimeScopes`](44-materialize_runtime_scopes.md) 之后、
[`InsertCommFence`](46-insert_comm_fence.md) 之前运行。跑得这么靠后意味着被分类
...
- [MaterializeRuntimeScopes](44-materialize_runtime_scopes.md) —— 紧邻的前一个 pass
