...
- `docs/zh-cn/dev/passes/32-allocate_memory_addr.md` —— 被绘制的那个 pass
- `docs/zh-cn/dev/passes/31-memory_reuse.md` —— 决定哪些生命周期可以共享 slot 的 pass
- `docs/zh-cn/dev/passes/00-pass_manager.md` —— `ReportInstrument`，现在只负责给出产物目录
- `docs/zh-cn/dev/04-simulator-trace-cleaning.md` —— `pypto.tools` 中另一个事后分析工具
