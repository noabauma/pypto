...
[LegalizeTileCast](../../dev/passes/17-legalize_tile_cast.md) for the class your chain falls
...
- [LegalizeTileCast](../../dev/passes/17-legalize_tile_cast.md) — when a cast chain is exact.
