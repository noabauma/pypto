...
1. **`split_aiv` attribute stamping** — the SOLE split path through this pass.
   ...
   [`LowerAutoVectorSplit`](19-lower_auto_vector_split.md)) has already lowered
...
- [`LowerAutoVectorSplit`](19-lower_auto_vector_split.md) — the live auto-split
...
- [`ExpandMixedKernel`](20-expand_mixed_kernel.md) — upstream producer of
  AIC/AIV functions and of the `dual_aiv_dispatch` marker.
- [`InjectGMPipeBuffer`](21-inject_gm_pipe_buffer.md) — runs immediately before;
  backend-gated GM pipe buffer wiring this pass relies on.
- [`NormalizeReturnOrder`](24-normalize_return_order.md) — runs immediately after.
