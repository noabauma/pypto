...
> [`LowerPipelineToSlots`](30-lower_pipeline_to_slots.md) runs immediately before this pass
...
- [`CanonicalizeIOOrder`](32-canonicalize_io_order.md) — the IO-order canonicalization pass that runs next, scoped to pipeline bodies
