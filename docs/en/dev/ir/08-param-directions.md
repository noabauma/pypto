...
| [Wrapper recovery + call sites](#3-wrapper-recovery-and-call-sites-pass-41) | 41 | What is each wrapper's *effective* signature, and what direction does each call-site argument have? |
...
### 3. Wrapper recovery and call sites (pass 41)
...
the check must run after `DeriveCallDirections` (pass 41), and `InitMemRef`
