...
- `docs/en/dev/passes/37-allocate_memory_addr.md` — the pass whose output is mapped
- `docs/en/dev/passes/36-memory_reuse.md` — the pass that decides which lifetimes may share a slot
